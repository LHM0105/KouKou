...
//			    	obj.innerHTML = '<div class="goods"><div class="goods-pic"><img src="img/'+ src +'" /></div><div class="goods-text"><p class="tit"><a href="#">裙裙欲动 欧美2015夏天气质夏裙连衣裙女</a></p><p class="store-name"><a href="#">裙裙旗舰店</a></p><p class="jia">￥<span>'+price+'</span></p></div><a href="detail.html" class="hover-box"><a href="#" class="buy">立即购买</a><a href="#" class="shou">加入收藏</a></a></div>';
				obj.innerHTML = '<div class="goods"> <div class="goods-pic"><img src="img/'+ src +'" /></div> <div class="goods-text"> <p class="tit"> <a href="#">裙裙欲动 欧美2015夏天气质夏裙连衣裙女</a> </p> <p class="store-name"> <a href="#">裙裙旗舰店</a> </p> <p class="jia">￥<span>'+price+'</span></p> </div> <div class="hover-box"> <a href="detail.html" class="linkDetail"></a> <a href="#" class="buy">立即购买</a> <a href="#" class="shou">加入收藏</a> </div> </div>'
			    	
//			    <div class="goods-box">
//					<div class="goods">
//						<div class="goods-pic">
//							<img src="img/m_14607024959680.jpg" />
//						</div>
//						<div class="goods-text">
//							<p class="tit"><a href="#">裙裙欲动 欧美2015夏天气质夏裙连衣裙女</a></p>
//							<p class="store-name"><a href="#">裙裙旗舰店</a></p>
//							<p class="jia">￥<span>168</span></p>
//						</div>
//						<div class="hover-box">
//							<a href="#" class="buy">立即购买</a>
//							<a href="#" class="shou">加入收藏</a>
//						</div>
//					</div>
//				</div>
